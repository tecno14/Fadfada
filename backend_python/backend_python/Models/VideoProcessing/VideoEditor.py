...
class VideoEditor:
    ...
    def __init__(self, input_video, token, mask_path = None, output_video = None):
    ...
    def hide_face(self, hide_voice = True):
        ...
        print("-Generate text ...")
        txt = TextClip(Text_end, color='FloralWhite',
